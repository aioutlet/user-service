...
import { getUsers, getUser, createUser, updateUser, deleteUser, getStats } from '../controllers/admin.controller.js';
...
router.get('/stats', getStats); // GET /admin/users/stats - supports includeRecent, recentLimit, period params
