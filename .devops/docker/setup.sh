...
# User Service - Docker Development Setup Commands
...
# =============================================================================
# STEP 3: MongoDB Docker Container Setup
# =============================================================================
...
docker exec -it mongodb-local mongosh -u admin -p admin123 --eval "
use user_service_db;
db.createUser({
  user: 'appuser',
  pwd: 'apppass123',
...
docker exec -it mongodb-local mongosh -u appuser -p apppass123 --authenticationDatabase user_service_db user_service_db
...
docker exec -it mongodb-local mongosh -u appuser -p apppass123 --authenticationDatabase user_service_db user_service_db --eval "
show collections;
...
# docker start mongodb-local                    # Start container
# docker stop mongodb-local                     # Stop container
# docker restart mongodb-local                  # Restart container
# docker logs mongodb-local                     # View container logs
# docker exec -it mongodb-local mongosh -u appuser -p apppass123 --authenticationDatabase user_service_db user_service_db
...
# docker logs mongodb-local         # View MongoDB logs
# docker exec -it mongodb-local bash # Connect to container shell
# docker volume ls                  # List Docker volumes
# docker volume inspect mongodb-local-data # Inspect volume
